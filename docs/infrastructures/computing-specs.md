...
|--------|-----|-----|-----|-----------|-------------|----------|
| **`up3080`** | Intel i7-11700 | RTX 3080 Ti (12 GB) | 126 GB | 140.112.13.236 | 192.168.250.236 | 1 GbE |
...
|------|----------|-------------|-----------|----------------------|
| DS1823xs+ (wangup26) | 35 TB | 192.168.250.182 | 140.112.12.139 | `homes` → `/home/NAS/house` (primary home) |
| DS923+ (wangup) | 83.7 TB | 192.168.250.139 | -  | `homes` → `/home/NAS/homes` (legacy), `data` → `/home/NAS/data` |
